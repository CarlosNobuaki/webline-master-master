    ...
    <div class="container justify-content-center">
        <form method="POST" action="insere_automovel.php">
            <div class="form-group">
                ...
                <div>
                    <input type="text" name="nome" class="form-control" placeholder="Digite o nome do veículo">
                </div>
            </div>
            ...
            <table class="table table-striped table-hover table-borderless">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="editar.php?id=<?php echo $dados['id'];?>" class="btn btn-primary"><svg
                                ...
                                <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal<?php echo $dados['id'];?>"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <div id="myModal<?php echo $dados['id'];?>" class="modal fade" role="dialog">
                        <div class="modal-dialog">                            
                            <div class="modal-content">
                                <div class="modal-header">                                    
                                    <h4 class="modal-title text-danger">Deletar Registro:  <?php echo $dados['id'];?></h4>
                                </div>
